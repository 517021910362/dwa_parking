...
class Waypoint(genpy.Message):
  _md5sum = "c9485ea189c3d3a8c14f93fb8e1796c0"
...
"""
  __slots__ = ['gid','lid','pose','twist','dtlane','change_flag','wpstate','lane_id','left_lane_id','right_lane_id','stop_line_id','cost','time_cost','lane_change_cost','direction']
  _slot_types = ['int32','int32','geometry_msgs/PoseStamped','geometry_msgs/TwistStamped','autoware_msgs/DTLane','int32','autoware_msgs/WaypointState','uint32','uint32','uint32','uint32','float32','float32','float32','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       gid,lid,pose,twist,dtlane,change_flag,wpstate,lane_id,left_lane_id,right_lane_id,stop_line_id,cost,time_cost,lane_change_cost,direction
    ...
    if args or kwds:
      ...
      if self.time_cost is None:
        self.time_cost = 0.
      if self.lane_change_cost is None:
        self.lane_change_cost = 0.
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_14d2i5B4I3fI().pack(_x.twist.twist.linear.x, _x.twist.twist.linear.y, _x.twist.twist.linear.z, _x.twist.twist.angular.x, _x.twist.twist.angular.y, _x.twist.twist.angular.z, _x.dtlane.dist, _x.dtlane.dir, _x.dtlane.apara, _x.dtlane.r, _x.dtlane.slope, _x.dtlane.cant, _x.dtlane.lw, _x.dtlane.rw, _x.change_flag, _x.wpstate.aid, _x.wpstate.lanechange_state, _x.wpstate.steering_state, _x.wpstate.accel_state, _x.wpstate.stop_state, _x.wpstate.event_state, _x.lane_id, _x.left_lane_id, _x.right_lane_id, _x.stop_line_id, _x.cost, _x.time_cost, _x.lane_change_cost, _x.direction))
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_14d2i5B4I3fI = None
def _get_struct_14d2i5B4I3fI():
    global _struct_14d2i5B4I3fI
    if _struct_14d2i5B4I3fI is None:
        _struct_14d2i5B4I3fI = struct.Struct("<14d2i5B4I3fI")
    return _struct_14d2i5B4I3fI
_struct_2i3I = None
