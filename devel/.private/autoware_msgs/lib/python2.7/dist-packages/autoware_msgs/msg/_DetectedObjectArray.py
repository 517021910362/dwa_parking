...
class DetectedObjectArray(genpy.Message):
  _md5sum = "c7b2093f9c4889609cdd1192e90254ca"
      ...
      for val1 in self.objects:
        ...
        for val3 in _v22.lanes:
          ...
          for val4 in val3.waypoints:
            ...
            _x = val4
            buff.write(_get_struct_4I3fI().pack(_x.lane_id, _x.left_lane_id, _x.right_lane_id, _x.stop_line_id, _x.cost, _x.time_cost, _x.lane_change_cost, _x.direction))
          _x = val3
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          for i in range(0, length):
            ...
            (_x.lane_id, _x.left_lane_id, _x.right_lane_id, _x.stop_line_id, _x.cost, _x.time_cost, _x.lane_change_cost, _x.direction,) = _get_struct_4I3fI().unpack(str[start:end])
...
def _get_struct_3f():
    ...
    return _struct_3f
_struct_4I3fI = None
def _get_struct_4I3fI():
    global _struct_4I3fI
    if _struct_4I3fI is None:
        _struct_4I3fI = struct.Struct("<4I3fI")
    return _struct_4I3fI
_struct_4d = None
def _get_struct_4d():
    global _struct_4d
