...
(cl:defclass <Waypoint> (roslisp-msg-protocol:ros-message)
  ((gid
   ...
   (time_cost
    ...
    :initform 0.0)
   (lane_change_cost
    :reader lane_change_cost
    :initarg :lane_change_cost
    :type cl:float
    :initform 0.0)
   (direction
    :reader direction
...
(cl:ensure-generic-function 'lane_change_cost-val :lambda-list '(m))
(cl:defmethod lane_change_cost-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:lane_change_cost-val is deprecated.  Use autoware_msgs-msg:lane_change_cost instead.")
  (lane_change_cost m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Waypoint>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'time_cost))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'lane_change_cost))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Waypoint>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'wpstate) istream)
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'lane_change_cost) (roslisp-utils:decode-single-float-bits bits)))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Waypoint>)))
  ...
  "c9485ea189c3d3a8c14f93fb8e1796c0")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Waypoint)))
  "Returns md5sum for a message object of type 'Waypoint"
  "c9485ea189c3d3a8c14f93fb8e1796c0")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Waypoint>))
  ...
  (cl:list 'Waypoint
    ...
    (cl:cons ':lane_change_cost (lane_change_cost msg))
