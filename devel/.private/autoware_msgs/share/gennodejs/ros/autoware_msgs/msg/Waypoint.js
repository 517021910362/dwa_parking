...
class Waypoint {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('lane_change_cost')) {
        this.lane_change_cost = initObj.lane_change_cost
      }
      else {
        this.lane_change_cost = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [lane_change_cost]
    bufferOffset = _serializer.float32(obj.lane_change_cost, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [lane_change_cost]
    data.lane_change_cost = _deserializer.float32(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return 'c9485ea189c3d3a8c14f93fb8e1796c0';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.lane_change_cost !== undefined) {
      resolved.lane_change_cost = msg.lane_change_cost;
    }
    else {
      resolved.lane_change_cost = 0.0
    }
