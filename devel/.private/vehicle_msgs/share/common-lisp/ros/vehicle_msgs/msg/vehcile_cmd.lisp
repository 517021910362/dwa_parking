...
;//! \htmlinclude vehcile_cmd.msg.html

(cl:defclass <vehcile_cmd> (roslisp-msg-protocol:ros-message)
  ((head1
    :reader head1
    :initarg :head1
    :type cl:fixnum
...
(cl:defclass vehcile_cmd (<vehcile_cmd>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <vehcile_cmd>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'vehcile_cmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vehicle_msgs-msg:<vehcile_cmd> is deprecated: use vehicle_msgs-msg:vehcile_cmd instead.")))

(cl:ensure-generic-function 'head1-val :lambda-list '(m))
(cl:defmethod head1-val ((m <vehcile_cmd>))
...
(cl:defmethod head2-val ((m <vehcile_cmd>))
...
(cl:defmethod length-val ((m <vehcile_cmd>))
...
(cl:defmethod steering-val ((m <vehcile_cmd>))
...
(cl:defmethod brake_force-val ((m <vehcile_cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vehicle_msgs-msg:brake_force-val is deprecated.  Use vehicle_msgs-msg:brake_force instead.")
  (brake_force m))

(cl:ensure-generic-function 'pedal_ratio-val :lambda-list '(m))
(cl:defmethod pedal_ratio-val ((m <vehcile_cmd>))
...
(cl:defmethod gear_position-val ((m <vehcile_cmd>))
...
(cl:defmethod working_mode-val ((m <vehcile_cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vehicle_msgs-msg:working_mode-val is deprecated.  Use vehicle_msgs-msg:working_mode instead.")
  (working_mode m))

(cl:ensure-generic-function 'racing_num-val :lambda-list '(m))
(cl:defmethod racing_num-val ((m <vehcile_cmd>))
...
(cl:defmethod racing_status-val ((m <vehcile_cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vehicle_msgs-msg:racing_status-val is deprecated.  Use vehicle_msgs-msg:racing_status instead.")
  (racing_status m))

(cl:ensure-generic-function 'checksum-val :lambda-list '(m))
(cl:defmethod checksum-val ((m <vehcile_cmd>))
  ...
  (checksum m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <vehcile_cmd>) ostream)
  "Serializes a message object of type '<vehcile_cmd>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <vehcile_cmd>) istream)
  "Deserializes a message object of type '<vehcile_cmd>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<vehcile_cmd>)))
  "Returns string type for a message object of type '<vehcile_cmd>"
  "vehicle_msgs/vehcile_cmd")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'vehcile_cmd)))
  "Returns string type for a message object of type 'vehcile_cmd"
  "vehicle_msgs/vehcile_cmd")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<vehcile_cmd>)))
  "Returns md5sum for a message object of type '<vehcile_cmd>"
  "f174333528b91e4bd29b231b98ffd01e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'vehcile_cmd)))
  "Returns md5sum for a message object of type 'vehcile_cmd"
  "f174333528b91e4bd29b231b98ffd01e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<vehcile_cmd>)))
  "Returns full string definition for message of type '<vehcile_cmd>"
  (cl:format cl:nil "uint8 head1~%uint8 head2~%uint8 length~%uint8 steering~%uint8 brake_force~%uint8 pedal_ratio~%uint8 gear_position~%uint8 working_mode~%uint8 racing_num~%uint8 racing_status~%uint16 checksum~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'vehcile_cmd)))
  "Returns full string definition for message of type 'vehcile_cmd"
  (cl:format cl:nil "uint8 head1~%uint8 head2~%uint8 length~%uint8 steering~%uint8 brake_force~%uint8 pedal_ratio~%uint8 gear_position~%uint8 working_mode~%uint8 racing_num~%uint8 racing_status~%uint16 checksum~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <vehcile_cmd>))
  (cl:+ 0
     1
     1
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <vehcile_cmd>))
