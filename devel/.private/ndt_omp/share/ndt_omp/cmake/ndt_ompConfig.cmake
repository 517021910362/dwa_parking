...
if("TRUE" STREQUAL "TRUE")
  set(ndt_omp_SOURCE_PREFIX /home/vv6/users/dingwenzhe/11_25/src/localization/ndt_omp-master)
  set(ndt_omp_DEVEL_PREFIX /home/vv6/users/dingwenzhe/11_25/devel/.private/ndt_omp)
  set(ndt_omp_INSTALL_PREFIX "")
  set(ndt_omp_PREFIX ${ndt_omp_DEVEL_PREFIX})
else()
  set(ndt_omp_SOURCE_PREFIX "")
  set(ndt_omp_DEVEL_PREFIX "")
  set(ndt_omp_INSTALL_PREFIX /home/vv6/users/dingwenzhe/11_25/install)
...
if(NOT "/home/vv6/users/dingwenzhe/11_25/src/localization/ndt_omp-master/include " STREQUAL " ")
  set(ndt_omp_INCLUDE_DIRS "")
  set(_include_dirs "/home/vv6/users/dingwenzhe/11_25/src/localization/ndt_omp-master/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ndt_omp' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vv6/users/dingwenzhe/11_25/src/localization/ndt_omp-master/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/vv6/users/dingwenzhe/11_25/devel/.private/ndt_omp/lib;/home/vv6/users/dingwenzhe/11_25/devel/lib;/opt/ros/melodic/lib)
